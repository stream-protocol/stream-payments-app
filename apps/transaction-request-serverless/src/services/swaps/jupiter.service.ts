...
const NO_QUOTE_FROM_JUPITER_ERROR_MESSAGE = 'There was no quote available for your swap.';

const NO_SWAP_FROM_JUPITER_ERROR_MESSAGE = 'There was no quote available for your swap.';
