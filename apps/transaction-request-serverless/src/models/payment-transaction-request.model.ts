...
export const paymentTransactionRequestScheme = object().shape({
    ...
    indexInputs: string().nullable(), //comma separated list of strings. public key is derived from the input and added onto an instruction. useful for finding payment transactions on chain later
});
