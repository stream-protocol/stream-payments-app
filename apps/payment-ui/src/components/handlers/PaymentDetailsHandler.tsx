...
import { WebsocketSessionState, getWebsocketSessionState } from '@/features/websocket/websocketSlice';
...
const PaymentDetailsHandler: React.FC = () => {
    ...
    useEffect(() => {
        if (shouldFetch && paymentId && websocketSessionState == WebsocketSessionState.connected) {
